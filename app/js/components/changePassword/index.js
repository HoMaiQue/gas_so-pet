        ...
        <Row>
          ...
          <Col xs={20} md={14} lg={10}>
            <form onSubmit={this.onSave} className="form-chang-pass">
              <h4>{this.props.t("CHANGE_PASS")}</h4>
              <div className="text-input">
                <label className="label">{this.state.email}</label>
                <div className="form-group">
                  <div className="input">
                    <label>{this.props.t("INPUT_OLD_PASSWORD")}</label>
                    <input
                      onChange={this.onChange}
                      type="password"
                      className="form-control"
                      placeholder={this.props.t("INPUT_OLD_PASSWORD")}
                      name="oldPassWord"
                  ...
                  <div className="input">
                    <label>{this.props.t("INPUT_NEW_PASSWORD")}</label>
                    <input
                      onChange={this.onChange}
                      type="password"
                      className="form-control"
                      placeholder={this.props.t("INPUT_NEW_PASSWORD")}
                      name="newPassWord"
                  ...
                  <div className="input">
                    <label>{this.props.t("RE_INPUT_NEW_PASSWORD")}</label>
                    <input
                      onChange={this.onChange}
                      type="password"
                      className="form-control"
                      placeholder={this.props.t("RE_INPUT_NEW_PASSWORD")}
