...
class ExportFactoryPopupNew extends React.Component {
  constructor(props) {
    super(props);
    this.form = null;
    this.state = {
  ...
  render() {
    return (
      <div className="modal fade" id="export-modal1" tabIndex="-1">
                  ...
                  <div className="row">
                    ...
                    {this.state.statusExisted && (
                      <div className="col-md-6" style={{ paddingTop: 35 }}>
                        <button onClick={this.onAutoCreateCylinder}>
                          {this.props.t("AUTO_CREATE")}
                        </button>
                      </div>
                    )}
                    <table
                ...
                <footer className="card-footer text-center">
                  <button
                    ...
                    onClick={(event) => {
                      ...
                      const modal = $("#export-modal1");
                      modal.modal("hide");
                    }}
                    type="submit"
                    data-toggle="modal"
                    data-target="#export-driver1"
                  >
                    {this.props.t("NEXT")}
                  </button>
                  <button
...
export default withNamespaces()(ExportFactoryPopupNew);
