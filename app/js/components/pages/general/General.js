    ...
    return (
      <div className="main-content">
              ...
              <form className="form-inline" onSubmit={e => this.onSubmit(e)}>
                <div className="form-group mb-2">
                  <select className="custom-select mr-sm-2" id="inlineSelect">
                    ...
                    <option value={2}>{this.props.t("CUSTOMER_DISTRIBUTOR")}</option>
                    ...
                    >
                      <thead >
                        <tr className="table__head">
                          ...
                          <th className="w-150px text-center align-middle">{this.props.t("DISTRIBUTOR_NAME")}</th>
        ...
        <AddUserPopupContainer
          ...
          newTable ={this.newTable.bind(this)}
          newTable1 ={this.newTable1.bind(this)}
