...
import deleteUserAPI from "./../../../../api/userRemoveUser";
...
class Restaurant extends React.Component {
    ...
    async componentDidMount() {
        ...
        let token = "Bearer " + user_cookies.token;
        let id = user_cookies.user.id;
        console.log("user_cookies.user",user_cookies.user);
        this.setState({ user_type: user_cookies.user.userType });
        //this.getAllUser();
        await this.getRestaurantCustomer(id, token);
    }
                                        ...
                                        >
                                            <thead className="table__head">
                                                <tr>
                                                    ...
                                                    <th className="w-150px text-center align-middle">{this.props.t("APARTMENT_NAME")}</th>
                                                    <th className="w-150px text-center align-middle">{this.props.t("ADDRESS_EXPORT_ORDER")}</th>
                                                    <th className="w-150px text-center align-middle">{this.props.t("CUSTOMER_GROUP")}</th>
                                                    ...
                                                    return (
                                                        <tr key={index}>
                                                            ...
                                                            <td className="text-center table-actions">
                                                                ...
                                                                <Tooltip title={this.props.t("SHOW_INFO")}>
