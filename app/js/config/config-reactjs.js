...
const urlSeeDetailDataSaler = urlReactjs + "/#/seetailddataSaler/:id";
...
export { urlChangePass, urlChangInformationUser, urlSeeDetailDataExport, urlDetailHistoryImport, urlCreateCalenderInpector,urlSeeDetailDataSaler };
